...
class ColorMaster extends HTMLElement {
  constructor() {
    super();
...
customElements.define("colormaster", ColorMaster);


const master = document.querySelector('colormaster');
...
window.addEventListener("message", (event) => {
  ...
  switch (message.type) {
    case "pose": {
      master.setAttribute('pose', message.pose);
      break;
    }
  }
});
